...
using HtmlTableProperty = VVPosM1.HtmlTableProperty;
using MeasurementOption = VVPosM1.MeasurementOption;
using HorizontalAlignOption = VVPosM1.HorizontalAlignOption;
using VerticalAlignOption = VVPosM1.VerticalAlignOption;
