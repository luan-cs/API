...
namespace VVPosM1
{
    public partial class frmLanguages : Form
    {
        ...
        private void cbbLanguages_DropDownClosed(object sender, EventArgs e)
        {
            ...
            {
                pbLogo.BackgroundImage = Properties.Resources.United_States_icon;
            }
            if (cbbLanguages.SelectedIndex == 1)
            {
                pbLogo.BackgroundImage = Properties.Resources.Japan_icon;
            }
            if (cbbLanguages.SelectedIndex == 2)
            {
                pbLogo.BackgroundImage = Properties.Resources.Vietnam_icon;
            }
        }
        #endregion
