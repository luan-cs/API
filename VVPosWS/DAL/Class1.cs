...
namespace VVPosWS.DAL
{
    public static partial class DataAccess
    {
        ...
        #region In Order
        public static void Print_Order(string cnStr, string OrderId, string Lang, string PlaceOfPrinting, ref string pError)
        {
            pError = "";
            bool print = DoPrintingOrder(OrderId, Lang, PlaceOfPrinting, ref pError);
        }
        //private static string Language;
        private static string OrId;
        public static bool DoPrintingOrder(string OrderId, string Lang, string PlaceOfPrinting, ref string Err)
        {
            //PlaceOfPrinting : 1,2,3 
            //PlaceOfPrinting : null , ""  có nghĩa là chọn máy in mặc định
            Err = "";
            try
            {
                ...
                //pd.PrinterSettings.PrinterName = @"CutePDF Writer";
                pd.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("A7", 300, 10000);
                pd.PrintPage += new PrintPageEventHandler(printDocumentOrder_PrintPage);
