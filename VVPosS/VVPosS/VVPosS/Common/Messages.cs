...
namespace VVPosS.Common
{
    class Messages
    {
        ...
        /// </summary>
        public static string msgEmptyMemberNumber = "Vui lòng nhập vào mã thành viên!";

        /// <summary>
        /// Define message error not exist of member number (member id)
        /// </summary>
        public static string msgNotExistMemberNumber = "Mã thành viên không tồn tại trong hệ thống!";

        /// <summary>
        /// Define message error format member number (member id)
        /// </summary>
        public static string msgErrorFormatMemberNumber = "Mã thành viên sai định dạng. Chỉ nhập số!";
        ...
        /// </summary>
        public static string msgErrorMemberCodeIsLock = "Thành viên này đã bị khóa!";
    }
}
