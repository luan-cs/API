...
using HtmlTableProperty = VVPosS.HtmlTableProperty;
using MeasurementOption = VVPosS.MeasurementOption;
using HorizontalAlignOption = VVPosS.HorizontalAlignOption;
using VerticalAlignOption = VVPosS.VerticalAlignOption;
